...
public abstract class Animatronic {
    ...
    public void setupVisual(SimpleApplication app, String texturePath) {
        ...
        // TAMAÑO DEL PNG
        visualSprite.setWidth(350);
        visualSprite.setHeight(500);

        // POSICION EN PANTALLA
        visualSprite.setPosition(450, 100);

        // AGREGAR A LA GUI
        app.getGuiNode().attachChild(visualSprite);
    ...
    // =========================================================
    // MOSTRAR / OCULTAR PNG SEGUN CAMARA
    // =========================================================
    protected void updateVisibility(GameManager game) {
        ...
        try {
            ...
            if (currentPosition != null
                    && !currentPosition.equals("Door")
                    && !currentPosition.equals("Jumpscare")) {
    ...
    protected void animatronicFailed(GameManager game) {
        ...
        System.out.println(
                "🚪 " + name + " fue detenido en la puerta"
        );
    ...
    public void setAggressionLevel(int level) {
        this.aggressionLevel = Math.min(level, 20);
    }
